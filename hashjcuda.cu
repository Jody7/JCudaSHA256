...
extern "C"
__global__ void sha256_init(SHA256_CTX *ctx){
...
__device__ void print_hex_memory(void *mem) {
  int i;
...
void host_struct_to_device(){
  cudaMalloc((SHA256_CTX**)&gpuSHA_CTX, THREADS * sizeof(SHA256_CTX));
}
void cudaAllocHash(){
  //cudaMalloc((uchar**)&gpuHash, THREADS * sizeof(plain));
}
